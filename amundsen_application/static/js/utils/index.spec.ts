...
describe('textUtils', () => {
  describe('convertText', () => {
    it('converts to lower case', () => {
      const actual = TextUtils.convertText('TESt LoWer cASe',
    ...
    it('converts to sentence case', () => {
      const actual = TextUtils.convertText('tESt sentence cASe',
    ...
    it('converts to upper case', () => {
      const actual = TextUtils.convertText('test upper cASe',
    ...
    it('converts to title case', () => {
      const actual = TextUtils.convertText('tEST title cASe',
