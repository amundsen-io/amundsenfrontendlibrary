...
interface BrowseTagsState {
  curatedTags: Tag[];
  otherTags: Tag[];
  isLoading: boolean;
}

export type BrowseTagsProps = StateFromProps & DispatchFromProps;

export class BrowseTags extends React.Component<BrowseTagsProps, BrowseTagsState> {
  constructor(props) {
    super(props);
...
export default connect<StateFromProps, DispatchFromProps>(mapStateToProps, mapDispatchToProps)(BrowseTags);
