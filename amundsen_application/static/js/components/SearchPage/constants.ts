...
export const SEARCH_INFO_TEXT_SUFFIX = `Ordered by the relevance of matches within a resource's metadata`;
export const SEARCH_INFO_TEXT_TABLE_PREFIX = ', as well as overall usage';
