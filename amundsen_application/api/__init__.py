...
def init_routes(app: Flask) -> None:
    ...
    app.add_url_rule('/storybook', 'storybook', storybook, defaults={'path': ''})
...
def storybook(path: str) -> Any:
    ## TODO: Stuck here, not finding the template
    return render_template("../storybook-static/templates/index.html", env=ENVIRONMENT)  # pragma: no cover
